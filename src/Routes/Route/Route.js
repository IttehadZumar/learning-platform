    ...
    children: [
      {
        ...
        loader: () => fetch('https://coursebd-server.vercel.app/course')
      },
      {
        path: '/course',
        element: <Course></Course>,
      ...
      },
      {
        ...
        loader: ({params}) => fetch(`https://coursebd-server.vercel.app/category/${params.id}`)
      },
      {
        path: '/course/:id',
        element: <Details></Details>,
        loader: ({params}) => fetch(`https://coursebd-server.vercel.app/course/${params.id}`)
      },
      {
        path: '/premium',
